...
$stmt = $pdo->prepare("SELECT a.id, a.sellerName, a.productName, a.description, a.price, a.quantity, a.img, a.date_added FROM products a, accounts b WHERE a.sellerName = b.username AND b.username = '$username' ORDER BY a.price");
$stmt->execute();
...
<div class="content read">
    ...
    <a href="read.php" class="sort-product">Sort By Date</a>
	<table>
        <thead>
            <tr>
                <td>Image</td>
